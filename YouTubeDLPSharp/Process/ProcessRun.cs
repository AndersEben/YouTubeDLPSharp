...
namespace YouTubeDLPSharp.Process
{
    ...
    public class ProcessRun
    {
        ...
        public ProcessRun(byte initialCount)
        {
            semaphore = new SemaphoreSlim(initialCount, MAX_COUNT);
            TotalCount = initialCount;
        }

        public async Task<(int, string[])> RunThrottled(YouTubeDLPProcess process, string[] urls, OptionSet options, CancellationToken ct, IProgress<DownloadProgress> progress = null)
        {
